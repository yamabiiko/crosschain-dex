...
\newcommand{\swappers}{\mathcal{L}}
\newcommand{\servers}{\mathcal{L}}
\newcommand{\coordinator}{\mathcal{S}}
\newcommand{\pool}{\mathcal{P}}
\newcommand{\ledger}{\mathcal{B}}
\newcommand{\smartcontract}{\mathcal{SC}}
\newcommand{\header}{\mathsf{H}}
...
\newcommand{\contest}{\mathsf{Contest}}
\newcommand{\xvec}{\mathbf{x}}
\renewcommand{\state}{\texttt{state}}
\newcommand{\buffer}{\texttt{buffer}}
\newcommand{\inputs}{\mathaccent"017E\mathcal{I}^T_H}
\newcommand{\transcript}{\mathaccent"017E\mathcal{T}}
\renewcommand{\round}{\texttt{round}}
\newcommand{\cround}{\texttt{c\_round}}

\newcommand{\chainb}{\mathbb{B}}
\newcommand{\chaina}{\mathbb{A}}
